...
function StandardDataTable(props) {
  const options = {
    ...
    onRowSelectionChange: (rowsSelectedData, allRows, rowsSelected) => {
      props.rowsSelectedIndex({ rowsSelected: rowsSelected, allRows: allRows, rowsSelectedData: rowsSelectedData })
    },
  ...
  return (
    <div>
      ...
      <MuiThemeProvider theme={getMuiTheme()}>
        <MUIDataTable
          title={<Typography variant="h6" align='left'>{props.title}</Typography>}
          data={props.data}
